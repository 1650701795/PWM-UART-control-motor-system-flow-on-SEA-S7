...
HD_PWD='D:/GitHub/GitHub_source/motor/PWM-UART-control-motor-system-flow-on-SEA-S7/PWM_motor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log motor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source motor_top.tcl
