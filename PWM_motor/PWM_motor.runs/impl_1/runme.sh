...
HD_PWD='D:/GitHub/GitHub_source/motor/PWM-UART-control-motor-system-flow-on-SEA-S7/PWM_motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log motor_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source motor_top.tcl -notrace
